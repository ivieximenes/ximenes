    ...
    <nav class="smt-drop-menu">
        <ul>
            <li>
             ...
             <li>
                <a target="_blank" href="/gamaoauth/gama" class="smt-logged-item">Carteirinha</a>
            </li>
            <li>
                <a target="_blank" href="/gamaoauth/gama" class="smt-logged-item">Dados pessoais</a>
            </li>
            <li>
			...
			submitHandler: function(form){
				...
				$.ajax({
					...
					success: function(data){
						...
						curForm.closest('.smt-modal-wrapper').find('.smt-modal-close').focus();						
