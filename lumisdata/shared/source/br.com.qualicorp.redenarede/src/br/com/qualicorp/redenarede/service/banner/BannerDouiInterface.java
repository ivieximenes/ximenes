...
{
//	private static String serviceInterfaceInstanceId;
	 ...
	 public void render(IServiceInterfaceRenderRequest request, IServiceInterfaceRenderResponse response) throws ServiceInterfaceException, PortalException
	{
		...
		//	setServiceInterfaceInstanceId(request);
			try
			{
				response.getWriter().write("<span id=\"lum_banner" + request.getServiceInterfaceInstanceConfig().getId() + "\"><script type=\"text/javascript\">\n" +
						"(function() {\n" +
						"var getbannerhref = \"" + br.com.qualicorp.redenarede.service.banner.BannerController.getBannerControllerUrl() +
...
/*	public void setServiceInterfaceInstanceId(IServiceInterfaceRenderRequest request){
		serviceInterfaceInstanceId = request.getServiceInterfaceInstanceId();
	}
	
	public static String getServiceInterfaceInstanceId(){
		return serviceInterfaceInstanceId;
	}*/
}
