...
public class BeneficiarioHandlerServiveLog implements SOAPHandler<SOAPMessageContext>
{
   private static ILogger logger = LoggerFactory.getLogger(BeneficiarioHandlerServiveLog.class);
   
   private static String[] secretsTags = {"senha", "confirmacaoSenha", "senhaAnterior"};
