...
(function ($) {
    $.widget("ui.tagit", {
        ...
        options:{
            ...
            renderTag: function(label, value, item) {
            	return $('<li class="tagit-choice"'
                        + (value !== undefined ? ' tagValue="' + value + '"' : '') + '>'
                        + (this.sortable == 'handle' ? '<a class="ui-icon ui-icon-grip-dotted-vertical" style="float:left"></a>' : '')
        ...
        _addTag:function (label, value) {
        	this._addTagItem({label: label, value: value});
        },
        ...
        _addTagItem:function (item) {
            ...
            tag.element = this.options.renderTag(label, value, item);
        ...
        _renderTag:function(label, value, item) {
        	return $('<li class="tagit-choice"'
                    + (value !== undefined ? ' tagValue="' + value + '"' : '') + '>'
